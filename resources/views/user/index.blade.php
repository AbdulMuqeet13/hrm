        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center d-flex">
                        <!-- Edit link -->
                        <a href="{{route('user.edit', $user->id)}}" class="btn btn-sm btn-primary me-1 pt-2" data-toggle="tooltip" data-placement="bottom" title="Edit User Data">
                            <i class="fa-solid fa-pen"></i>
                        </a>
                         <form action="{{ route('user.destroy' , $user->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete User Data"><i class="fa-solid fa-trash"></i></button>
                        </form>
